...
<body>
    <nav class="container-fluid" id="main-nav-login">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <a href="/" id="logo-large">BUSINESS MANAGEMENT</a>
                </div>
    ...
    <section class="container-fluid" id="body-register-form">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h3>This application helped you to manage your business.</h3>
<!--                    <img src="img/manage.png">-->
                </div>
                <div class="col-md-6">
                    <h3>Create an account</h3>
                    <p>New account will be added to table.</p>
                    <div class="alert-danger">
                        ${requestScope.error}
                    </div>
                    <form action="ProcessRegister" method="get" class="register-form">
